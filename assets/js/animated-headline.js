jQuery(document).ready(function($){
    ...
    var animationDelay = 5000,
        ...
        barWaiting = barAnimationDdelay - 3000, //3000 is the duration of the transition on the loading bar - set in the scss/css file
        // letters effect
        lettersDelay = 50,
        // type effect
    ...
    function initHeadline(){
        ...
        // intitialise headline animation
    ...
    function animateHeadline($headlines) {
        ...
        $headlines.each(function(){
            ...
            if(headline.hasClass('loading-bar')) {
                ...
                // assubg to .box-words-wrapper the width of its longest word
            ...
            // trigger animation
            setTimeout(function(){ hideWord( headline.find('.is-visible').eq(0) ) },
            duration );
        });
    }
    ...
    function hideWord($word) {
        ...
        if($word.parents('.box-headline').hasClass('type')) {
            ...
            setTimeout(function(){
                ...
                $word.removeClass('is-visible').addClass('is-hidden').children('i')
        ...
        typeAnimationDelay);
            ...
            $word.parents('.box-words-wrapper').animate({ width: '2px'}, revealDuration, 
            function(){
    ...
    function showWord($word, $duration) {
        if($word.parents('.box-headline').hasClass('type')) {
            ...
            $word.parents('.box-words-wrapper').animate({ 'width' : $word.width() + 10 },
